# CHANGELOG
## [v1.5.3](https://github.com/NubeIO/lora-raw/tree/v1.5.3) (2020-05-03) 
### Added
- Device API validation
- Retain True for value publish (by convention)
- Create MQTT Listener for removing unnecessary retained msgs
- Update MQTT values on device PATCH

## [v1.5.2](https://github.com/NubeIO/lora-raw/tree/v1.5.2) (2020-04-23) 
### Added
- Publish over MQTT device_point_name (not name)

## [v1.5.1](https://github.com/NubeIO/lora-raw/tree/v1.5.1) (2020-04-22) (deleted)
### Added
...
## [v1.5.0](https://github.com/NubeIO/lora-raw/tree/v1.5.0) (2020-04-22) (deleted)
### Fix
- Fix to point scale

## [v1.4.9](https://github.com/NubeIO/lora-raw/tree/v1.4.9) (2020-04-21) (deleted)
### Fix
- Remove points like snr
- Made it so point name is not unique
